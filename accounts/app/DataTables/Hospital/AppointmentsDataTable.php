...
class AppointmentsDataTable extends DataTable
{
    ...
    public function __construct()
    {
        ...
        $this->hospital_id = session('hospital_id');
    }
    /**
    ...
    {
        $id = session('hospital_id') ?? Auth::user()->id;
        $model = Appointment::query()->with(['doctor','hospital','patient','schedule'])->where('hospital_id',$id);
        if($this->status)
        {
