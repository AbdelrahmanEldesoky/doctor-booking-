...
class RatingDataTable extends DataTable
{
    ...
    {
        $model = Rating::query()->where('user_id',auth()->user()->id);
    ...
    {
        return [
            ['data' => 'rating', 'name' => 'rating', 'title' => trans('site.rating'), 'orderable' => false],
            ['data' => 'comment', 'name' => 'comment', 'title' =>  trans('site.comment'), 'orderable' => false],
        ];
    }
