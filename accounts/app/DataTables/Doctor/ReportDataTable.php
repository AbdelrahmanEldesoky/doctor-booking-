...
class ReportDataTable extends DataTable
{
    ...
    public function query()
    {
        ...
        if(session('date'))
        {
            ...
            $model = $model->whereHas('appointment',function($q) use($start,$end){
                     $q->whereDate('from','>=',$start)->whereDate('from','<=',$end);
                     });
    ...
    {
        return [
            ['data' => 'schedule.date', 'name' => 'schedule.date', 'title' => trans('site.session'), 'orderable' => false],
            ['data' => 'schedule.from', 'name' => 'schedule.from', 'title' => trans('site.from'), 'orderable' => false],
            ['data' => 'schedule.to', 'name' => 'schedule.to', 'title' => trans('site.to'), 'orderable' => false],
            ['data' => 'schedule.interval', 'name' => 'schedule.interval', 'title' => trans('site.duration'), 'orderable' => false],
            ['data' => 'session_amount', 'name' => 'session_amount', 'title' => trans('site.session_price'), 'orderable' => false],
            ['data' => 'paid_amount', 'name' => 'paid_amount', 'title' => trans('site.paid_price'), 'orderable' => false],
        ];
    }
