...
class TransactionDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('_', 'doctor.transactions.action')
            ->rawColumns(['action']);
    }
    ...
    {
        return [
            ['data' => 'user.name', 'name' => 'user.name', 'title' => trans('site.name'), 'orderable' => false],
            ['data' => 'user.email', 'name' => 'user.email', 'title' => trans('site.email'), 'orderable' => false],
            ['data' => 'amount', 'name' => 'amount', 'title' => trans('site.amount'), 'orderable' => false],
            ['data' => 'created_at', 'name' => 'created_at', 'title' => trans('site.Date'), 'orderable' => false],
            Column::computed('_')
            ->exportable(false)
            ->printable(false)
            ->searchable(false)
