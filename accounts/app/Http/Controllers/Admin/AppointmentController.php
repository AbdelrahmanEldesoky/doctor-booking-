...
use App\DataTables\Admin\AppointmentsDataTable;
...
class AppointmentController extends Controller
{
    ...
    public function index(AppointmentsDataTable $dataTable, Request $request)
    {
        ...
        return $dataTable->render('admin.appointments.index', get_defined_vars());
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.appointments.show', get_defined_vars());
    }
