...
<html  class="light-layout" dir="ltr">
@else
<html  class="light-layout" dir="rtl">
@endif
...
{{-- <footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2022
        <a class="ml-25" href="javascript:;">Ipersona</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-right d-none d-md-block">Picnave<i data-feather="heart"></i></span></p>
</footer> --}}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">@lang('site.edit_schedule')</h5>
