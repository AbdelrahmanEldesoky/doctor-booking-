<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en"><head>
    ...
    <![endif]-->
    <title>Send Password Email Address</title>
...
<div style="display: none;">Send Password email address</div>
                                ...
                                <tbody><tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        ...
                                        <p style="margin: 0 0 24px;">
                                            <!-- Please Wait untill admin approve you. your profile is under consideration. -->
                                            Congratulations! Your profle is approved from admin. so, there are following credentials
                                        </p>
                                        <p>
                                            Email: {{$details['email']}}
                                            <br>
                                        ...
                                        <p style="margin: 0 0 24px;">
                                            If you did not sign up to Ipersona, please ignore this email or contact us at
                                            <a href="mailto:info@ipersona.me" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">info@ipersona.me</a>
                                        </p>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" role="presentation" cellspacing="0" cellpadding="0">
                                            <tbody><tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" bgcolor="rgba(115, 103, 240, var(--bg-opacity))">
                                                    <a href="{{ route('home') }}" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Goto Home →</a>
                                                </td>
                                            </tr>
                                            </tbody></table>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <p style="margin: 0 0 16px;">Thanks, <br>Ipersona Team</p>
                                    </td>
                                </tr>
                                <tr>
