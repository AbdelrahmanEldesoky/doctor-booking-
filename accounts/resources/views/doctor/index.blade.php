...
@section('title','IPersona -  آي بيرسونا')
@push('cs')
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-primary">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p>@lang('site.Total_appointments')</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p>@lang('site.Completed_appointments')</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-stethoscope font-medium-5"></i>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p>@lang('site.Canceled_appointments')</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-stethoscope font-medium-5"></i>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p> @lang('site.In_progress_appointments')</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-stethoscope font-medium-5"></i>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-primary ">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p>@lang('site.Received_payments')</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-secondary ">
                                <div class="inner" style="color:white!important">
                                    ...
                                    <p>@lang('site.This_month_payments')</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-credit-card font-medium-5"></i>
                                </div>
