...
@section('title', trans('site.Schedules'))
@push('css')
                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <div class="d-flex justify-content-between">
                            <h2 class="content-header-title float-left mb-0">@lang('site.Schedules')</h2>
                            <button class="btn btn-primary action_btn" id="schedule_action">Create / إنشاء</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="nav nav-pills nav-fill">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="create-tab-fill" data-toggle="pill"
                                            href="#create" aria-expanded="true">@lang('site.Create')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="bulk-tab-fill" data-toggle="pill" href="#bulk"
                                            aria-expanded="false"> @lang('site.Bulk_create')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="repeat-tab-fill" data-toggle="pill" href="#bulk_repeat"
                                            aria-expanded="false"> @lang('site.Bulk_create_repeated')</a>
                                    </li>
                                </ul>
                                        ...
                                        <form method="POST" action="{{route('doctor.schedules.create')}}"
                                            ...
                                            <div class="row">
                                               <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="basicInput"> @lang('site.Interval')</label>
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <option value="{{$day}}" class="">{{ trans('site.'.$day) }}</option>
                                                            @endforeach
</select>
                                                        </div>
                                                    </div>
                                                <div class="col-md-6" id="pick-a-time">
                                                    <div class="form-group">
                                                        <label for="basicInput"> @lang('site.from')</label>
                                                ...
                                                <div class="col-md-6 clinic_box hide">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="" class="text-capitalize">
                                                                 @lang('site.Select_Clinic')</option>
                                                        @foreach($clinics as $itemm)
                                                            <option value="{{$itemm->id}}" class="text-capitalize">
                                                                {{$itemm->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
...
<script>
    $(document).on('click', '.action_btn', function () {
        ...
        var x = $(this).text();
        // if (x == ) {
        //     $(this).text(@lang('site.close'));
        // } else {
        //     $(this).text(@lang('site.create'));
        // }
    })

$(document).on('change','.schedule_type',function(){
     $(this).closest('form').find('.clinic_box').toggleClass('hide');
})
</script>
@endpush
