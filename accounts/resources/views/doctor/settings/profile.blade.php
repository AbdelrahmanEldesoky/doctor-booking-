                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                            ...
                                            <!-- header media -->
                                            <form class="validate-form mt-2" action="{{route('doctor.profile')}}"
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-price"
                                             aria-labelledby="account-pill-price" aria-expanded="true">
                                            <!-- header media -->
                                            <form class="validate-form mt-2" action="{{route('doctor.prices')}}"
                                                  method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name">@lang('site.online_session_price')</label>
                                                            <input type="text" class="form-control"
                                                                   name="online_price" placeholder=""
                                                                   value="{{$user->online_price}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name"> (@lang('site.Outside')) @lang('site.online_session_price')</label>
                                                            <input type="text" class="form-control"
                                                                   name="online_price_outside" placeholder=""
                                                                   value="{{$user->online_price_outside}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name"> @lang('site.ofline_session_price')</label>
                                                            <input type="text" class="form-control"
                                                                   name="ofline_price" placeholder=""
                                                                   value="{{$user->ofline_price}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name"> @lang('site.cs_number')</label>
                                                            <input type="text" class="form-control"
                                                                   name="cs_number" placeholder=""
                                                                   value="{{$user->cs_number}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name"> @lang('site.waiting_time')</label>
                                                            <input type="text" class="form-control"
                                                                   name="waiting_time" placeholder="30 minutes"
                                                                   value="{{$user->waiting_time}}"/>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="account-name">Ofline Session Price (Outside)</label>
                                                            <input type="text" class="form-control"
                                                                   name="online_price_outside" placeholder=""
                                                                   value="{{$user->online_price_outside}}"/>
                                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-clinic"
                                             aria-labelledby="account-pill-clinic" aria-expanded="true">
                                            <!-- header media -->
                                            <form class="validate-form mt-2" action="{{route('doctor.clinics')}}"
                                                  method="POST" enctype="multipart/form-data">
                                                @csrf

                                                <div class="row append_images">
                                                    @if($images->count() > 0)
                                                    ...
                                                    <div class="col-md-4 position-relative">
                                                        ...
                                                        @endif
                                                        <input type="hidden" name="default_image_ids[]" value="{{$image->id}}" >
                                                        <input type="file" class="dropify" name="files[]" data-default-file="{{asset($image->image)}}">
                                                    </div>
                                                    @endforeach
                                                    @else
                                                    <div class="col-md-4">
                                                ...
                                                <button class="btn btn-primary " type="submit"> @lang('site.submit')</button>
                                                    <button class="btn btn-primary add_image" type="button"> @lang('site.add_more')</button>
                                                </div>
                                            </form>
                                            <!--/ form -->
                                        </div>
                                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                            ...
                                            <!-- form -->
                                            <form class="validate-form" action="{{route('doctor.update.password')}}"
                                                  method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="tab-pane fade" id="zoom_box" role="tabpanel"
                                             aria-labelledby="account-pill-password" aria-expanded="false">
                                            <!-- form -->
                                            <form class="validate-form" action="{{route('doctor.linkZoom')}}"
                                                  method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="account-new-password">(@lang('site.required')) @lang('site.zoom_email')</label>
                                                            <div
                                                                class="input-group form-password-toggle input-group-merge">
                                                                <input type="text"
                                                                        name="email"
                                                                       value="{{ $user->zoom_email }}"
                                                                       class="form-control"
                                                                       required/>
                                                            </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="account-new-password"> @lang('site.zoom_link_accessonly')</label>
                                                            <div
                                                                class="input-group form-password-toggle input-group-merge">
                                                                <input type="text"
                                                                       value="{{$user->zoom_id}}"
                                                    ...
                                                    <div class="col-12 text-right text-end">
                                                        <button type="submit" class="btn btn-primary">@lang('site.link_account')</button>
                                                    </div>
