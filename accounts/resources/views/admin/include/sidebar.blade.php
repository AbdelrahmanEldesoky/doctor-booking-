        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('admin.ratings.index')}}">
                    <i class="fa fa-stethoscope"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">Ratings</span>
                </a>
            </li>
              <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('admin.revenue.index')}}">
                    <i class="fa fa-stethoscope"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">Revenue</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('admin.setting.news')}}">
                    <i class="fa fa-stethoscope"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">NewsLetter</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('admin.setting.messages')}}">
                    <i class="fa fa-stethoscope"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">Contact Messages</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('admin.promocodes.index')}}">
                    <i class="fa fa-stethoscope"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">Promocodes</span>
                </a>
            </li>
            <!-- <li class=" nav-item">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{ route('admin.notifications.index') }}">
                    <i data-feather='settings'></i>
                    <span class="menu-title text-truncate" data-i18n="Email"> Notifications</span>
                </a>
            </li>
